...
const GAMEPLAY_CONFIG = {
  ...
  tanks: {
    maxPlayers: 2,
    totalLevels: 21,
    // Tank Assault uses a fixed fit-to-map camera like Wii Play: Tanks!, not player-follow.
    // These values leave a small border so the full arena, cover, bullets, and spawns stay visible.
    cameraFitPadding: 44,
    cameraFitMinZoom: 0.25,
    cameraFitMaxZoom: 1.08,
    // Kept for older code/config compatibility; the live Tank camera now fits the whole map.
    cameraZoom: 1.14,
    // Tank Assault gets its own short look-around pause each time a mission loads.
    // Movement and shooting are frozen, but turret/camera aiming can still update.
    startFreezeSeconds: 2.0,
    levelTransitionSeconds: 2.4,
    playerSize: 24,
    playerSpeed: 190,
    playerSprintSpeed: 245,
    // Player bullets
    playerBulletSpeed: 640,
    playerBulletRadius: 7,
    playerMaxBullets: 5,
    playerBulletBounces: 1,
    playerShotCooldown: 0.34,
    // M1 burst control: first 3 shots keep the current fast cooldown.
    // If players keep spam-clicking after that, shots slow down until this meter recharges.
    playerBurstFastShots: 3,
    playerBurstRechargeRate: 0.55,
    playerBurstStrainDecayRate: 0.65,
    playerBurstSlowPenalty: 0.28,
    playerBurstSlowStep: 0.2,
    playerBurstMaxCooldown: 1.35,
    playerBulletTtl: 4.8,
    // Enemy tiers follow the Wii Play: Tanks! idea: stationary browns, defensive grays,
    // rockets, mine-layers, aggressive reds, ricochet snipers, purple elites, and a final phantom.
    enemyTiers: {
      husk: {
        // Brown: stationary, slow single shell, one wall ricochet.
        displayName: "Brown",
        speed: 0,
        bulletSpeed: 420,
        bulletRadius: 7,
      ...
      shade: {
        // Dark Grey: slow defensive mover, keeps distance, single shell, one ricochet.
      ...
      bolt: {
        // Teal: slow defensive rocket tank. Fast straight missiles, no wall ricochet.
        displayName: "Teal",
        speed: 76,
        bulletSpeed: 820,
        bulletRadius: 8,
      ...
      sapper: {
        // Yellow: quicker mine-layer, up to four mines, normal one-bounce shell.
        displayName: "Yellow",
        speed: 132,
        bulletSpeed: 480,
        bulletRadius: 7,
      ...
      charger: {
        // Red: fast offensive hunter, up to three active one-bounce shells.
        displayName: "Red",
        speed: 164,
        bulletSpeed: 560,
        bulletRadius: 8,
      ...
      sniper: {
        // Green: stationary precision rocket sniper, two active rockets, two ricochets.
        displayName: "Green",
        speed: 0,
        bulletSpeed: 720,
        bulletRadius: 8,
      ...
      elite: {
        // Purple: fast offensive elite, five active shells, two mines, one ricochet.
        displayName: "Purple",
        speed: 186,
        bulletSpeed: 640,
        bulletRadius: 8,
      ...
      blackHunter: {
        // Black: fastest aggressive rocket rusher, two active missiles, no ricochet, two mines.
        displayName: "Black",
        speed: 228,
        bulletSpeed: 900,
        bulletRadius: 8,
      ...
      amberBoss: {
        isBoss: true,
        bossName: "Amber Bulwark",
        bossAbilities: ["crossBurst", "armorDash", "mineRing"],
        size: 58,
        health: 240,
        bulletDamageTaken: 10,
        speed: 74,
        bossPreferredRange: 310,
        bossStrafeSkill: 0.55,
        bulletSpeed: 470,
        bulletRadius: 8,
        maxBullets: 70,
        bulletBounces: 1,
        ...
        bulletTtl: 4.5,
        bossCooldownMin: 0.9,
        bossCooldownMax: 1.45,
        crossDuration: 2.1,
        crossShotInterval: 0.32,
        crossBulletSpeed: 500,
        dashChargeSeconds: 0.85,
        dashSeconds: 0.72,
        dashSpeed: 340,
        mineDuration: 1.7,
        mineDropInterval: 0.26,
        mineRadius: 38,
        mineFuse: 0.95,
        mineTtl: 7.5,
        maxMines: 10
      ...
      crimsonBoss: {
        isBoss: true,
        bossName: "Crimson Cyclone",
        bossAbilities: ["railSweep", "splitVolley", "orbitMines"],
        size: 68,
        health: 390,
        bulletDamageTaken: 10,
        speed: 92,
        bossPreferredRange: 360,
        bossStrafeSkill: 0.85,
        bulletSpeed: 560,
        bulletRadius: 8,
        maxBullets: 90,
        bulletBounces: 0,
        fireRange: 1200,
        bulletTtl: 4.6,
        bossCooldownMin: 0.85,
        bossCooldownMax: 1.3,
        railDuration: 2.8,
        railShotInterval: 0.14,
        railBulletSpeed: 720,
        splitDuration: 2.3,
        splitShotInterval: 0.34,
        splitBulletSpeed: 620,
        mineDuration: 2.6,
        mineDropInterval: 0.36,
        mineRadius: 42,
        mineFuse: 0.7,
        mineTtl: 9,
        maxMines: 12
      ...
      prismBoss: {
        isBoss: true,
        bossName: "Violet Prism",
        bossAbilities: ["pinwheelRicochet", "mirrorSplit", "gravityWell"],
        size: 76,
        health: 560,
        bulletDamageTaken: 10,
        speed: 104,
        bossPreferredRange: 410,
        bossStrafeSkill: 1.05,
        bulletSpeed: 620,
        bulletRadius: 8,
        maxBullets: 120,
        bulletBounces: 2,
        fireRange: 1300,
        bulletTtl: 5.6,
        bossCooldownMin: 0.75,
        bossCooldownMax: 1.2,
        pinwheelDuration: 3.1,
        pinwheelShotInterval: 0.13,
        pinwheelBulletSpeed: 600,
        mirrorDuration: 2.4,
        mirrorShotInterval: 0.26,
        mirrorBulletSpeed: 660,
        gravityDuration: 3.0,
        gravityShotInterval: 0.42,
        gravityRadius: 330,
        gravityPullSpeed: 84
      },
      voidBoss: {
        ...
        bossCooldownMax: 1.7,
        starDuration: 2.4,
        starShotInterval: 0.20,
        starBulletSpeed: 520,
        shockwaveChargeSeconds: 1.45,
        shockwaveRadius: 270,
        focusDuration: 5.0,
        focusShotInterval: 0.18,
        focusBulletSpeed: 700,
        spiralDuration: 3.1,
        spiralShotInterval: 0.115,
        spiralBulletSpeed: 560,
        mineDuration: 2.3,
        mineDropInterval: 0.42,
        mineRadius: 46,
        mineFuse: 0.75,
        mineTtl: 8,
        maxMines: 8
      ...
      phantom: {
        // White: fast invisible phantom after mission intro; visible through fading tracks.
        displayName: "White",
        stealthAfterStart: true,
        leavesTracks: true,
        speed: 198,
        bulletSpeed: 690,
        bulletRadius: 7,
