  ...
  for (const [role, roleDef] of Object.entries(roles)) {
    ...
    for (const perk of Object.values(roleDef?.perks || {})) {
      const levels = perkLevelRows(perk).map((level) => ({
        ...
        slowDuration: level.slowDuration == null ? undefined : Number(level.slowDuration),
        ...
        vaporTrailSpeedMultiplier: level.vaporTrailSpeedMultiplier == null ? undefined : Number(level.vaporTrailSpeedMultiplier),
        vaporTrailDuration: level.vaporTrailDuration == null ? undefined : Number(level.vaporTrailDuration),
